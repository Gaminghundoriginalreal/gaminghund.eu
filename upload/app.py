...
# Hochgeladene Dateien anzeigen und herunterladen
@app.route('/uploads/<file_id>')
def serve_file(file_id):
    file_info = files.get(file_id)
    if file_info:
        return send_from_directory(app.config['UPLOAD_FOLDER'], file_id, as_attachment=True, download_name=file_info['filename'])
    return 'Datei nicht gefunden!'
